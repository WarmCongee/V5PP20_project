...
旨在通过ROS仿真实践，学习ROS基础，视觉处理，导航避障，路径规划，机器人方向的基础知识，以及实践通过**Git仓库**进行团队的项目管理，由队员**自主分工**选择负责内容和学习方向，通过**团队协作**完成项目。

### 1.1 项目要求

基于Ubuntu18.04 ROS\melodic Gazebo仿真平台实现仿真功能，其他所需功能包及平台可以自由选择。
...
[dadwadw233](https://github.com/dadwadw233)：实现导航与定位功能，控制机器人到达指定位置。

[lzfazl](https://github.com/lzfazl)：实现导航与定位功能，修改构建机器人模型。
...
[lzfazl](https://github.com/lzfazl)，[dadwadw233](https://github.com/dadwadw233)：学习到了Linux系统的操作，ros的使用，对机器人slam的整体框架形成了认知，了解和尝试使用建图和定位的几个功能包，感觉收获蛮多。
