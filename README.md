...
如果您也是刚开始学习ROS，可以尝试根据该README运行修改一个集导航，视觉，策略控制在内的完整的仿真工程。了解一个完整的入门工程，相信会对你的ROS学习有很大的帮助。当然该工程还有很多方面尚待优化完善，如果你有任何问题，可以在Issues中说明，或者通过邮件联系。可以提出任何建议或任何问题，我们会很乐意一起交流学习。
