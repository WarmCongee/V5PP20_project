...
class NavTest():  
    def __init__(self):  
        ...
        locations['2'] = Pose(Point(14.5, 45, 0.000),  Quaternion(0.000, 0.000, -0.447, 0.894))  
        #locations['2'] = Pose(Point(14.5, 45, 0.000),  Quaternion(0.000, 0.000, -0.847, 0.532))  
        #locations['3'] = Pose(Point(14.5, 45, 0.000), Quaternion(0.000, 0.000, 0.000, 1.000))  
        #locations['4'] = Pose(Point(14.5, 45, 0.000), Quaternion(0.000, 0.000, 0.645, 0.764))  
        #locations['5'] = Pose(Point(14.5, 45, 0.000), Quaternion(0.000, 0.000, 0.340, 0.940))  
        #locations['6'] = Pose(Point(14.5, 45, 0.000),   Quaternion(0.000, 0.000, 0.000, 1.000))  
...
def chase(pos):
    ...
    if pos.flag == 1 and kict_flag == 0:
        ...
        uuid, ["~/catkin_v520/src/mbot_navigation/launch/gmapping.launch"])
